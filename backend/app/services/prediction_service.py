...
from app.services.artifact_prediction_service import predict_nhits_mock, predict_tabnet, predict_tft_cached
...
def predict_for_customer(customer_id: str) -> PredictionResponse:
    ...
    results = [
        ...
        _safe_model_result("TFT", lambda: predict_tft_cached(customer.customer_id)),
